-- =============================================================================
-- BazarHQ — Secure Public Order Tracking
--
...
comment on function public.get_public_order_tracking(text, text, text) is
  'Secure public tracking using exact store slug, public order ID, and normalized Bangladesh customer phone. Returns a minimized response and archives delivered orders after 90 days.';
